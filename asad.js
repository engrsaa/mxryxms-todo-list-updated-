    ...
    let questions = await inquirer.prompt([
        {
            ...
            validate: (input) => {
                ...
                // let cleanInput = input.trim();//while adding new element in todo array also use trim mehod as commented there
                // if(cleanInput==''){
                if (input == '') {
...
if (updateList.update == 'Replace') {
    ...
    let cleanNewTask = newTask;
    if (index >= 0 && index < todo.length) {
        todo[index] = cleanNewTask;
